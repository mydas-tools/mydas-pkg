...
nits=dim(mp)[6]
set.seed(4321)
sr_deviances=FLife:::rlnoise(nits,rec(    om)[,,,,,1]%=%0,0.3,b=0.0)
u_deviances =FLife:::rlnoise(nits,stock.n(om)[,,,,,1]%=%0,0.2,b=0.0)
...
mseRay=mseXSA(om,
              ...
              sr_deviances=sr_deviances,u_deviances=u_deviances)
...
omYr=fwd(omYr,fbar=fbar(om)[,-1],sr=eq,residuals=sr_deviances)
...
omYc=fwd(omYc,fbar=fbar(omYc)[,-1],sr=eq,residuals=sr_deviances)
